...
var AuthService = /*#__PURE__*/function () {
  ...
  return _createClass(AuthService, [{
     ...
     */
    function () {
      var _register = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(registerDto) {
        var username, password, existingUser, hashedPassword, newUser, _, userWithoutPassword;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              username = registerDto.username, password = registerDto.password;
              _context.next = 3;
            ...
            case 12:
              ...
              _ = newUser.password, userWithoutPassword = _objectWithoutProperties(newUser, _excluded);
              return _context.abrupt("return", userWithoutPassword);
            case 14:
            case "end":
    ...
    key: "login",
    value: (function () {
      var _login = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(loginDto) {
